...
const args=process.argv.slice(2),portIndex=args.indexOf('--port'),port=portIndex>=0?Number(args[portIndex+1]):4173,root=existsSync(join(process.cwd(),'dist'))?join(process.cwd(),'dist'):process.cwd();
